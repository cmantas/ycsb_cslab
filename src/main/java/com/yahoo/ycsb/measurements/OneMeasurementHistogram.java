...
import static com.yahoo.ycsb.Client.clientno;
...
import static cslab.GangliaReporter.report;
...
//    exporter.write(getName(), ">"+_buckets, histogramoverflow);
	...
	public String getSummary() {
		...
		windowtotallatency=0;
		windowoperations=0;
                //report latency to ganglia
                if(!getName().equals("CLEANUP"))
                    report("ycsb_"+getName(),clientno, report/1000, "msec" );
